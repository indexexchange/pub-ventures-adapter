...
var PartnerSpecificValidator = require('pub-ventures-htb-validator.js');
 ...
 * @class
 */
function PubVenturesHtb(configs) {
    /* =====================================
     * Data
     * ---------------------------------- */
    ...
    */
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'PubVenturesHtb', // PartnerName
            namespace: 'PubVenturesHtb', // Should be same as partnerName
            statsId: 'PBVN', // Unique partner identifier
            version: '2.0.0',
            targetingType: 'slot',
            enabledAnalytics: {
                requestTime: true
